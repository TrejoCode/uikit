...
var Feather = function (_a) {
    ...
    var Icono = Fi[String(icon)];
    return React.createElement(Icono, __assign({ size: size, color: color }, rest));
};
...
var Icon = function (_a) {
    ...
    return (React.createElement("span", null,
        React.createElement(Feather, __assign({ icon: icon, size: size, color: color }, props))));
};
...
var Button = forwardRef(function (_a, ref) {
    ...
    return (React.createElement("button", __assign({ ref: ref, className: classnames('tc-button', SizesRecord[size], ColorsRecord[color], VariationsRecord[variation], (_b = {
        ...
        loading && (React.createElement("span", { "aria-live": "polite", "aria-busy": "true", className: "ml-1" },
            React.createElement(Icon, { icon: "Loader", size: 16, className: classnames(getIconClassNames(), 'animate-spin') })))));
});
