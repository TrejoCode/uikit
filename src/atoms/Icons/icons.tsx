...
export const icons = {
  ...
  moon: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12.081 2.509a1 1 0 0 1-.067 1.085 6 6 0 0 0 8.392 8.392 1 1 0 0 1 1.59.896A10 10 0 1 1 11.118 2.004a1 1 0 0 1 .963.505Zm-2.765 1.93a8 8 0 1 0 10.245 10.245A8.001 8.001 0 0 1 9.316 4.439Z"
      fill="#1D1D1D"
    />
  ),
  notification: (
  ...
  share2: (
    <path
      d="M8.71 7.71 11 5.41V15a1 1 0 0 0 2 0V5.41l2.29 2.3a1 1 0 0 0 1.639-.325 1 1 0 0 0-.219-1.095l-4-4a1 1 0 0 0-.33-.21 1 1 0 0 0-.76 0 1 1 0 0 0-.33.21l-4 4a1.004 1.004 0 1 0 1.42 1.42ZM21 14a1 1 0 0 0-1 1v4a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-4a1 1 0 1 0-2 0v4a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3v-4a1 1 0 0 0-1-1Z"
      fill="#1D1D1D"
    />
  ),
  externalLink: (
  ...
  music: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M21.646 2.237A1 1 0 0 1 22 3v13a1 1 0 1 1-2 0V4.18L10 5.847V18a1 1 0 1 1-2 0V5a1 1 0 0 1 .836-.986l12-2a1 1 0 0 1 .81.223Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 16a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0ZM18 14a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z"
        fill="#1D1D1D"
      />
    </>
  ),
  help: (
    <>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.258 8.024a2 2 0 0 0-2.225 1.308 1 1 0 1 1-1.886-.664 4 4 0 0 1 7.773 1.333c0 1.53-1.135 2.54-1.945 3.081a8.049 8.049 0 0 1-1.686.848l-.035.013-.011.003-.004.002h-.002L11.92 13l.316.949a1 1 0 0 1-.633-1.897H11.6h.002l.016-.006.074-.027a6.06 6.06 0 0 0 1.172-.6c.69-.46 1.055-.95 1.055-1.419v-.001a2 2 0 0 0-1.662-1.975ZM11 17a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2H12a1 1 0 0 1-1-1Z"
        fill="#1D1D1D"
      />
    </>
  ),
  fraction: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm0 2a5 5 0 1 0 0-10 5 5 0 0 0 0 10ZM5 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM19 20a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM21 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM3 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM12 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM19 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM12 22a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM5 20a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm0 1a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"
      fill="#1D1D1D"
    />
  ),
  delete: (
  ...
  alert: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.528 2.283a3 3 0 0 1 4.037 1.058l.003.005 8.47 14.14.008.014a3 3 0 0 1-2.565 4.5H3.519a2.999 2.999 0 0 1-2.565-4.5l.008-.014 8.47-14.14.858.514-.855-.519a3 3 0 0 1 1.093-1.058Zm.618 2.094L2.683 18.506A1 1 0 0 0 3.536 20h16.928a1 1 0 0 0 .853-1.494L12.855 4.379l-.001-.002a1 1 0 0 0-1.708 0Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 8a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0V9a1 1 0 0 1 1-1ZM11 17a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2H12a1 1 0 0 1-1-1Z"
        fill="#1D1D1D"
      />
    </>
  ),
  ...
  medium: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M5.976 7.7a.645.645 0 0 0-.21-.545L4.21 5.28V5h4.832l3.735 8.191L16.06 5h4.607v.28l-1.33 1.276a.39.39 0 0 0-.149.373v9.374a.39.39 0 0 0 .148.373l1.3 1.275v.28h-6.537v-.28l1.347-1.307c.132-.131.132-.17.132-.372V8.694l-3.743 9.506h-.505L6.972 8.695v6.371a.879.879 0 0 0 .241.73l1.75 2.124v.28H4v-.28l1.75-2.124a.846.846 0 0 0 .226-.73V7.699Z"
      fill="#1D1D1D"
    />
  ),
  instagram: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.167 5A3.167 3.167 0 0 0 5 8.167V16.5a3.167 3.167 0 0 0 3.167 3.167H16.5a3.167 3.167 0 0 0 3.167-3.167V8.167A3.167 3.167 0 0 0 16.5 5H8.167ZM3 8.167A5.167 5.167 0 0 1 8.167 3H16.5a5.167 5.167 0 0 1 5.167 5.167V16.5a5.167 5.167 0 0 1-5.167 5.167H8.167A5.167 5.167 0 0 1 3 16.5V8.167Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.711 9.99a2.333 2.333 0 1 0-.684 4.616 2.333 2.333 0 0 0 .684-4.617ZM10.373 8.45a4.334 4.334 0 1 1 3.992 7.693 4.334 4.334 0 0 1-3.992-7.693ZM15.916 7.75a1 1 0 0 1 1-1h.009a1 1 0 1 1 0 2h-.009a1 1 0 0 1-1-1Z"
        fill="#1D1D1D"
      />
    </>
  ),
  ...
  brand: (
    <>
      <g clipPath="url(#a)" fillRule="evenodd" clipRule="evenodd" fill="#1D1D1D">
  ...
  notificationBadge: (
    <>
      <path
        ...
        fill="#1D1D1D"
      />
      <path d="M21 6a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" fill="#FF2828" />
    </>
  ),
  drag: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6 12a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM6 5a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM6 19a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM14 12a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM14 5a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM14 19a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z"
      fill="#1D1D1D"
    />
  ),
  skipBack: (
  ...
  collection: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.846 7A.846.846 0 0 0 7 7.846v8.308c0 .467.379.846.846.846h8.308a.846.846 0 0 0 .846-.846v-1.846a1 1 0 1 1 2 0v1.846A2.846 2.846 0 0 1 16.154 19H7.846A2.846 2.846 0 0 1 5 16.154V7.846A2.846 2.846 0 0 1 7.846 5h1.846a1 1 0 0 1 0 2H7.846Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.846 11a.846.846 0 0 0-.846.846v8.308c0 .467.379.846.846.846h8.308a.846.846 0 0 0 .846-.846v-1.846a1 1 0 1 1 2 0v1.846A2.846 2.846 0 0 1 12.154 23H3.846A2.846 2.846 0 0 1 1 20.154v-8.308A2.846 2.846 0 0 1 3.846 9h1.846a1 1 0 0 1 0 2H3.846Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.846 3a.846.846 0 0 0-.846.846v8.308c0 .467.379.846.846.846h8.308a.846.846 0 0 0 .846-.846V3.846A.846.846 0 0 0 20.154 3h-8.308ZM9 3.846A2.846 2.846 0 0 1 11.846 1h8.308A2.846 2.846 0 0 1 23 3.846v8.308A2.846 2.846 0 0 1 20.154 15h-8.308A2.846 2.846 0 0 1 9 12.154V3.846Z"
        fill="#1D1D1D"
      />
    </>
  ),
  ...
  home: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14.456 5.177a4 4 0 0 0-4.912 0l-4 3.111A4 4 0 0 0 4 11.445V20a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-8.555a4 4 0 0 0-1.544-3.157l-4-3.111Zm-6.14-1.579a6 6 0 0 1 7.368 0l4 3.111A6 6 0 0 1 22 11.445V20a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-8.555A6 6 0 0 1 4.316 6.71l4-3.11Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 13a2 2 0 0 0-2 2v7a1 1 0 1 1-2 0v-7a4 4 0 0 1 8 0v7a1 1 0 1 1-2 0v-7a2 2 0 0 0-2-2Z"
        fill="#1D1D1D"
      />
    </>
  ),
  ...
  addFriend: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.464 15.464A5 5 0 0 1 5 14h7a5 5 0 0 1 5 5v2a1 1 0 1 1-2 0v-2a3 3 0 0 0-3-3H5a3 3 0 0 0-3 3v2a1 1 0 1 1-2 0v-2a5 5 0 0 1 1.464-3.536ZM8.5 4.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0ZM20 7a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0V8a1 1 0 0 1 1-1Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
    ...
    <>
      <g clipPath="url(#a)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M13.78.596a1 1 0 0 1 .562 1.042l-1.027 7.395H22.5a1 1 0 0 1 .72 1.694l-12 12.466a1 1 0 0 1-1.7-.892l1.423-7.001H1.5a1 1 0 0 1-.734-1.68L12.618.82A1 1 0 0 1 13.78.597ZM3.79 13.3h8.378a1 1 0 0 1 .98 1.2l-.982 4.828 7.985-8.295h-7.983a1 1 0 0 1-.99-1.137l.747-5.382L3.789 13.3Z"
          fill="#1D1D1D"
        />
      </g>
      <defs>
  ...
  reveal: (
    <>
      <g clipPath="url(#a)" fillRule="evenodd" clipRule="evenodd" fill="#1D1D1D">
        <path d="M22.688 5.274a1 1 0 0 1 .038 1.414l-9 9.5a1 1 0 0 1-1.433.02l-4.268-4.269-6.294 6.743A1 1 0 1 1 .27 17.318l7-7.5a1 1 0 0 1 1.438-.025l4.274 4.273 8.293-8.754a1 1 0 0 1 1.414-.038Z" />
        <path d="M16 5a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0V6h-5a1 1 0 0 1-1-1Z" />
      </g>
      <defs>
        <clipPath id="a">
          <path fill="#fff" d="M0 0h24v24H0z" />
  ...
  shareOptions: (
    <>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 12.4a3 3 0 0 1 3-3h14a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-7Zm3-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-7a1 1 0 0 0-1-1H5Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.998 2.4a4 4 0 0 0-4 4v4a1 1 0 1 1-2 0v-4a6 6 0 0 1 10.243-4.243l-.707.708.707-.708A6 6 0 0 1 18 6.4v4a1 1 0 0 1-2 0v-4a4 4 0 0 0-1.172-2.828M11.998 2.4a4 4 0 0 1 2.829 1.172L11.998 2.4Z"
        fill="#1D1D1D"
      />
    </>
  ),
  pending: (
    <path
      d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18a8 8 0 1 1 0-16.001A8 8 0 0 1 12 20Zm-.503-14a1 1 0 0 1 1 1v4.93l3.37 3.37a1.003 1.003 0 0 1-1.74 1l-3.5-3.6a1 1 0 0 1-.11-.59l-.02-.11V7a1 1 0 0 1 1-1Z"
      fill="#1D1D1D"
    />
  ),
  redeem: (
    <>
      <path d="M8 12a4 4 0 1 0 8 0" stroke="#1D1D1D" strokeWidth={2} strokeLinecap="round" />
      <path
        ...
        strokeWidth={2}
      />
      <path d="M3 9h18" stroke="#1D1D1D" strokeWidth={2} strokeLinecap="round" />
    </>
  ),
  powerOn: (
    <>
      <path
        d="M19.092 5.344a1.206 1.206 0 0 0-.85-.344 1.229 1.229 0 0 0-.852.344 1.174 1.174 0 0 0-.352.832 1.152 1.152 0 0 0 .352.831 7.396 7.396 0 0 1 2.087 3.813 7.288 7.288 0 0 1-.433 4.304 7.488 7.488 0 0 1-2.808 3.343A7.753 7.753 0 0 1 12 19.722a7.753 7.753 0 0 1-4.236-1.255 7.488 7.488 0 0 1-2.808-3.343 7.288 7.288 0 0 1-.433-4.304A7.396 7.396 0 0 1 6.61 7.007a1.174 1.174 0 0 0 .352-.831 1.152 1.152 0 0 0-.352-.832A1.206 1.206 0 0 0 5.759 5a1.228 1.228 0 0 0-.851.344 9.7 9.7 0 0 0-2.72 5.003 9.56 9.56 0 0 0 .579 5.636 9.822 9.822 0 0 0 3.684 4.375A10.17 10.17 0 0 0 12 22a10.17 10.17 0 0 0 5.55-1.642 9.823 9.823 0 0 0 3.683-4.375 9.56 9.56 0 0 0 .58-5.636 9.7 9.7 0 0 0-2.72-5.003Z"
        fill="#000"
      />
      <path d="M12 12V2" stroke="#1C1C1C" strokeWidth={2} strokeLinecap="round" />
    </>
  ),
  fixedPrice: (
    <>
      <path
        d="m21.393 13.906-7.48 7.482a2.085 2.085 0 0 1-2.952 0l-8.668-8.66A1 1 0 0 1 2 12.02V2h10.018a1 1 0 0 1 .707.293l8.668 8.67a2.087 2.087 0 0 1 0 2.943Z"
        stroke="#1D1D1D"
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 7c0-.552.445-1 .995-1h.01C7.555 6 8 6.448 8 7s-.445 1-.995 1h-.01A.998.998 0 0 1 6 7Z"
        fill="#1D1D1D"
      />
    </>
  ),
  auctionTime: (
    <path
      d="M15 2H9v2h6V2Zm-4 13h2V9h-2v6Zm8.03-6.61 1.42-1.42c-.43-.51-.9-.99-1.41-1.41l-1.42 1.42A8.962 8.962 0 0 0 12 5a9 9 0 0 0-9 9c0 4.97 4.02 9 9 9a8.994 8.994 0 0 0 7.03-14.61ZM12 21c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7Z"
      fill="#1D1D1D"
    />
  ),
  openForOffers: (
    <path
      d="M19.143 11.783h-1.905c0-1.148-.714-2.181-1.78-2.583L9.59 7H2v10.522h5.714v-1.378L14.381 18 22 15.609v-.957a2.86 2.86 0 0 0-2.857-2.87ZM3.905 15.609V8.913H5.81v6.696H3.905ZM14.352 16l-6.638-1.846V8.913h1.534l5.542 2.076c.324.124.543.44.543.794 0 0-1.895-.048-2.19-.144l-2.267-.755-.6 1.817 2.267.755c.486.163.99.25 1.505.25h5.095a.96.96 0 0 1 .857.535L14.352 16Z"
      fill="#1D1D1D"
    />
  ),
  infoFilled: (
    <>
      <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z" fill="#1D1D1D" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.01 17a1 1 0 0 1-1-1v-4a1 1 0 1 1 2 0v4a1 1 0 0 1-1 1ZM13.01 8a1 1 0 0 1-1 1H12a1 1 0 1 1 0-2h.01a1 1 0 0 1 1 1Z"
        fill="#fff"
      />
    </>
  ),
  checkmarkFilled: (
    <>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.873 8.26a1 1 0 0 1 .067 1.413l-6 6.6a1 1 0 0 1-1.477.003l-3-3.273a1 1 0 1 1 1.474-1.351l2.26 2.465 5.263-5.79a1 1 0 0 1 1.413-.067Z"
        fill="#fff"
      />
    </>
  ),
  errorFilled: (
    <>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.707 8.707a1 1 0 0 0-1.414-1.414L12 10.586 8.707 7.293a1 1 0 0 0-1.414 1.414L10.586 12l-3.293 3.293a1 1 0 1 0 1.414 1.414L12 13.414l3.293 3.293a1 1 0 0 0 1.414-1.414L13.414 12l3.293-3.293Z"
        fill="#fff"
      />
    </>
  ),
  ...
  equalizerFilled: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M7 11.333V18H4v-6.667h3ZM11.333 6v12h-3V6h3ZM15.667 9.333V18h-3V9.333h3ZM20 14v4h-3v-4h3Z"
      fill="#1D1D1D"
    />
  ),
  pauseFilled: (
    <path d="M10 18V6a2 2 0 1 0-4 0v12a2 2 0 1 0 4 0ZM18 18V6a2 2 0 1 0-4 0v12a2 2 0 1 0 4 0Z" fill="#1D1D1D" />
  ),
  documentFilled: (
    <>
      <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-7-7Z" fill="#1D1D1D" />
      <path d="M13 2v7h7" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" />
    </>
  ),
  volumeInactiveFilled: (
    <>
      <path
        d="M14 4.066a1 1 0 0 0-1.62-.784L7.05 7.5a1 1 0 0 1-.62.215H2a1 1 0 0 0-1 1v6.572a1 1 0 0 0 1 1h4.43a1 1 0 0 1 .62.215l5.33 4.217a1 1 0 0 0 1.62-.784V4.066Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.707 9.707a1 1 0 0 0-1.414-1.414L19 10.586l-2.293-2.293a1 1 0 1 0-1.414 1.414L17.586 12l-2.293 2.293a1 1 0 0 0 1.414 1.414L19 13.414l2.293 2.293a1 1 0 0 0 1.414-1.414L20.414 12l2.293-2.293Z"
        fill="#1D1D1D"
      />
    </>
  ),
  volumeActiveFilled: (
    <>
      <path
        d="M15 4.066a1 1 0 0 0-1.62-.784L8.05 7.5a1 1 0 0 1-.62.215H3a1 1 0 0 0-1 1v6.572a1 1 0 0 0 1 1h4.43a1 1 0 0 1 .62.215l5.33 4.217a1 1 0 0 0 1.62-.784V4.066Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.483 7.144a1 1 0 0 1 1.373.34C18.61 8.73 19 10.355 19 12c0 1.644-.391 3.27-1.144 4.517a1 1 0 0 1-1.712-1.034c.528-.875.856-2.127.856-3.483 0-1.357-.328-2.608-.856-3.483a1 1 0 0 1 .34-1.373Z"
        fill="#1D1D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.432 4.177a1 1 0 0 1 1.391.255C22.237 6.482 23 9.206 23 12c0 2.794-.763 5.518-2.177 7.568a1 1 0 0 1-1.646-1.136C20.324 16.77 21 14.457 21 12c0-2.457-.676-4.769-1.823-6.432a1 1 0 0 1 .255-1.391Z"
        fill="#1D1D1D"
      />
    </>
  ),
  ...
  largeDisplayFilled: (
    <path
      fill="#1D1D1D"
      d="M4 4h6.857v6.857H4zM4 13.143h6.857V20H4zM13.143 4H20v6.857h-6.857zM13.143 13.143H20V20h-6.857z"
    />
  ),
  smallDisplayFilled: (
    <path
      fill="#1D1D1D"
      d="M4 15.429h4.571V20H4zM4 9.714h4.571v4.571H4zM4 4h4.571v4.571H4zM15.429 15.429H20V20h-4.571zM15.429 9.714H20v4.571h-4.571zM15.429 4H20v4.571h-4.571zM9.714 15.429h4.571V20H9.714zM9.714 9.714h4.571v4.571H9.714zM9.714 4h4.571v4.571H9.714z"
    />
  ),
  saveFilled: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M5.507 20.87a.996.996 0 0 0 1.007-.012l5.322-3.195 5.672 3.208A1 1 0 0 0 19 20V5.334C19 4.047 18.013 3 16.8 3H7.2C5.987 3 5 4.047 5 5.334V20a1 1 0 0 0 .507.87Z"
      fill="#1D1D1D"
    />
  ),
  musicFilled: (
  ...
  imageFilled: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M19 17.834c0 .644-.448 1.166-1 1.166H6l7.566-6.817c.246-.245.692-.244.933-.001L19 16.66v1.174ZM8 7a1.5 1.5 0 1 1-.001 3.001A1.5 1.5 0 0 1 8 7Zm10-4H6C4.346 3 3 4.346 3 6v12c0 1.654 1.346 3 3 3h12c1.654 0 3-1.346 3-3V6c0-1.654-1.346-3-3-3Z"
      fill="#1D1D1D"
    />
  ),
  starFilled: (
    <path
      d="M11.715 2.878a.3.3 0 0 1 .57 0l1.893 5.825a.3.3 0 0 0 .285.207h6.124a.3.3 0 0 1 .177.543l-4.955 3.6a.3.3 0 0 0-.109.335l1.893 5.824a.3.3 0 0 1-.462.335l-4.955-3.6a.3.3 0 0 0-.352 0l-4.955 3.6a.3.3 0 0 1-.462-.335L8.3 13.388a.3.3 0 0 0-.109-.336l-4.955-3.6a.3.3 0 0 1 .177-.542h6.124a.3.3 0 0 0 .285-.207l1.893-5.825Z"
      fill="#1D1D1D"
    />
  ),
  addFilled: (
