...
const PreviewColors = (): React.ReactElement => (
    ...
    <div className="container flex flex-col">
      ...
      <div className="flex px-4 mb-8">
        <div className="w-1/2 flex flex-col">
          ...
          <span className="text-sm">theme.colors.primary-alt</span>
        </div>
        <div className="w-1/2 flex">
          <div className="w-full h-12 bg-primary-alt-base rounded-lg flex justify-center items-center text-white">
            #288091
          </div>
          <div className="w-full h-12 bg-primary-alt-lighten rounded-lg flex justify-center items-center text-white">
            #5299A7
          </div>
          <div className="w-full h-12 bg-primary-alt-darken rounded-lg flex justify-center items-center text-white">
            #206674
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row px-4 mb-8">
        <div className="w-1/2 flex flex-col">
          ...
          <span className="text-sm">theme.colors.secondary-alt</span>
        </div>
        <div className="w-1/2 flex">
          <div className="w-full h-12 bg-secondary-alt-base rounded-lg flex justify-center items-center text-white">
            #516376
          </div>
          <div className="w-full h-12 bg-secondary-alt-lighten rounded-lg flex justify-center items-center text-white">
            #738291
          </div>
          <div className="w-full h-12 bg-secondary-alt-darken rounded-lg flex justify-center items-center text-white">
            #404F5E
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row px-4 mb-8">
        ...
        <div className="w-1/2">
          <div className="w-full h-12 bg-gray rounded-lg flex justify-center items-center text-white">
            #6c6c6c
          </div>
        </div>
      </div>
