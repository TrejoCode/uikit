...
function _objectWithoutProperties$4u(source, excluded) { if (source == null) return {}; var target = _objectWithoutPropertiesLoose$4u(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function _objectWithoutPropertiesLoose$4u(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
 ...
 */
const Feather = (_a) => {
    var { icon, size } = _a, rest = __rest(_a, ["icon", "size"]);
    // @ts-expect-error No types for Feather as signatures
    const Icon = FeatherIcon[String(icon)] || Activity;
    return React.createElement(Icon, Object.assign({ size: size }, rest));
};
 ...
 */
const Icon = (_a) => {
    var { icon, size = 32, color = colors.primary.base, ariaLabel = undefined, ariaHidden = undefined } = _a, props = __rest(_a, ["icon", "size", "color", "ariaLabel", "ariaHidden"]);
    return (React.createElement("span", { role: "img", "aria-label": ariaLabel, "aria-hidden": ariaHidden },
        React.createElement(Feather, Object.assign({ icon: icon, size: size, color: color }, props))));
};
...
var u=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var y=e=>e===false?"false":e===true?"true":e===0?"0":e,p$1=e=>{if(!e||typeof e!="object")return  true;for(let t in e)return  false;return  true},g=(e,t)=>{if(e===t)return  true;if(!e||!t)return  false;let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return  false;for(let s=0;s<n.length;s++){let f=n[s];if(!r.includes(f)||e[f]!==t[f])return  false}return  true};function o(e,t){for(let n=0;n<e.length;n++){let r=e[n];Array.isArray(r)?o(r,t):t.push(r);}}var i=(...e)=>{let t=[];o(e,t);let n=[];for(let r=0;r<t.length;r++)t[r]&&n.push(t[r]);return n},c=(e,t)=>{let n={};for(let r in e){let s=e[r];if(r in t){let f=t[r];Array.isArray(s)||Array.isArray(f)?n[r]=i(f,s):typeof s=="object"&&typeof f=="object"&&s&&f?n[r]=c(s,f):n[r]=f+" "+s;}else n[r]=s;}for(let r in t)r in e||(n[r]=t[r]);return n},l=/\s+/g,h=e=>!e||typeof e!="string"?e:e.replace(l," ").trim();

var r=null,s=null,p=async()=>r||s||(s=Promise.resolve().then(function () { return bundleMjs; }).then(t=>(r=t,t)).catch(()=>null),s),m=t=>n=>{if(s&&!r)return n;if(r){let{twMerge:e,extendTailwindMerge:l}=r;return (p$1(t)?e:l({...t,extend:{theme:t.theme,classGroups:t.classGroups,conflictingClassGroupModifiers:t.conflictingClassGroupModifiers,conflictingClassGroups:t.conflictingClassGroups,...t.extend}}))(n)}try{let{twMerge:e,extendTailwindMerge:l}=u("tailwind-merge");return r={twMerge:e,extendTailwindMerge:l},(p$1(t)?e:l({...t,extend:{theme:t.theme,classGroups:t.classGroups,conflictingClassGroupModifiers:t.conflictingClassGroupModifiers,conflictingClassGroups:t.conflictingClassGroups,...t.extend}}))(n)}catch{return p(),n}};

var st={twMerge:true,twMergeConfig:{},responsiveVariants:false},x=(...l)=>{let u=[];X(l,u);let t="";for(let d=0;d<u.length;d++)u[d]&&(t&&(t+=" "),t+=u[d]);return t||void 0};function X(l,u){for(let t=0;t<l.length;t++){let d=l[t];Array.isArray(d)?X(d,u):d&&u.push(d);}}var P=null,B={},F=false,S=(...l)=>u=>{let t=x(l);return !t||!u.twMerge?t:((!P||F)&&(F=false,P=m(B)),P(t)||void 0)},Q=(l,u)=>{for(let t in u)t in l?l[t]=x(l[t],u[t]):l[t]=u[t];return l},rt=(l,u)=>{let{extend:t=null,slots:d$1={},variants:R={},compoundVariants:q=[],compoundSlots:A=[],defaultVariants:L={}}=l,m={...st,...u},M=t?.base?x(t.base,l?.base):l?.base,y$1=t?.variants&&!p$1(t.variants)?c(R,t.variants):R,T=t?.defaultVariants&&!p$1(t.defaultVariants)?{...t.defaultVariants,...L}:L;!p$1(m.twMergeConfig)&&!g(m.twMergeConfig,B)&&(F=true,B=m.twMergeConfig);let j=p$1(t?.slots),$=p$1(d$1)?{}:{base:x(l?.base,j&&t?.base),...d$1},N=j?$:Q({...t?.slots},p$1($)?{base:l?.base}:$),w=p$1(t?.compoundVariants)?q:i(t?.compoundVariants,q),V=b$1=>{if(p$1(y$1)&&p$1(d$1)&&j)return S(M,b$1?.class,b$1?.className)(m);if(w&&!Array.isArray(w))throw new TypeError(`The "compoundVariants" prop must be an array. Received: ${typeof w}`);if(A&&!Array.isArray(A))throw new TypeError(`The "compoundSlots" prop must be an array. Received: ${typeof A}`);let Z=(n,e,s=[],o)=>{let a=s;if(typeof e=="string"){let c=h(e).split(" ");for(let f=0;f<c.length;f++)a.push(`${n}:${c[f]}`);}else if(Array.isArray(e))for(let r=0;r<e.length;r++)a.push(`${n}:${e[r]}`);else if(typeof e=="object"&&typeof o=="string"&&o in e){let r=e[o];if(r&&typeof r=="string"){let f=h(r).split(" "),p=[];for(let i=0;i<f.length;i++)p.push(`${n}:${f[i]}`);a[o]=a[o]?a[o].concat(p):p;}else if(Array.isArray(r)&&r.length>0){let c=[];for(let f=0;f<r.length;f++)c.push(`${n}:${r[f]}`);a[o]=c;}}return a},U=(n,e=y$1,s=null,o=null)=>{let a=e[n];if(!a||p$1(a))return null;let r=o?.[n]??b$1?.[n];if(r===null)return null;let c$1=y(r),f=Array.isArray(m.responsiveVariants)&&m.responsiveVariants.length>0||m.responsiveVariants===true,p=T?.[n],i=[];if(typeof c$1=="object"&&f)for(let[C,G]of Object.entries(c$1)){let nt=a[G];if(C==="initial"){p=G;continue}Array.isArray(m.responsiveVariants)&&!m.responsiveVariants.includes(C)||(i=Z(C,nt,i,s));}let v=c$1!=null&&typeof c$1!="object"?c$1:y(p),h=a[v||"false"];return typeof i=="object"&&typeof s=="string"&&i[s]?Q(i,h):i.length>0?(i.push(h),s==="base"?i.join(" "):i):h},_=()=>{if(!y$1)return null;let n=Object.keys(y$1),e=[];for(let s=0;s<n.length;s++){let o=U(n[s],y$1);o&&e.push(o);}return e},K=(n,e)=>{if(!y$1||typeof y$1!="object")return null;let s=[];for(let o in y$1){let a=U(o,y$1,n,e),r=n==="base"&&typeof a=="string"?a:a&&a[n];r&&s.push(r);}return s},W={};for(let n in b$1){let e=b$1[n];e!==void 0&&(W[n]=e);}let z=(n,e)=>{let s=typeof b$1?.[n]=="object"?{[n]:b$1[n]?.initial}:{};return {...T,...W,...s,...e}},D=(n=[],e)=>{let s=[],o=n.length;for(let a=0;a<o;a++){let{class:r,className:c,...f}=n[a],p=true,i=z(null,e);for(let v in f){let h=f[v],C=i[v];if(Array.isArray(h)){if(!h.includes(C)){p=false;break}}else {if((h==null||h===false)&&(C==null||C===false))continue;if(C!==h){p=false;break}}}p&&(r&&s.push(r),c&&s.push(c));}return s},tt=n=>{let e=D(w,n);if(!Array.isArray(e))return e;let s={},o=S;for(let a=0;a<e.length;a++){let r=e[a];if(typeof r=="string")s.base=o(s.base,r)(m);else if(typeof r=="object")for(let c in r)s[c]=o(s[c],r[c])(m);}return s},et=n=>{if(A.length<1)return null;let e={},s=z(null,n);for(let o=0;o<A.length;o++){let{slots:a=[],class:r,className:c$1,...f}=A[o];if(!p$1(f)){let p=true;for(let i in f){let v=s[i],h=f[i];if(v===void 0||(Array.isArray(h)?!h.includes(v):h!==v)){p=false;break}}if(!p)continue}for(let p=0;p<a.length;p++){let i=a[p];e[i]||(e[i]=[]),e[i].push([r,c$1]);}}return e};if(!p$1(d$1)||!j){let n={};if(typeof N=="object"&&!p$1(N)){let e=S;for(let s in N)n[s]=o=>{let a=tt(o),r=et(o);return e(N[s],K(s,o),a?a[s]:void 0,r?r[s]:void 0,o?.class,o?.className)(m)};}return n}return S(M,_(),D(w),b$1?.class,b$1?.className)(m)},Y=()=>{if(!(!y$1||typeof y$1!="object"))return Object.keys(y$1)};return V.variantKeys=Y(),V.extend=t,V.base=M,V.slots=N,V.variants=y$1,V.defaultVariants=T,V.compoundSlots=A,V.compoundVariants=w,V};
...
const useButtonController = () => {
        ...
        compoundVariants: [
            {
                color: "primary",
                variant: "outline",
                class: "text-primary-base hover:bg-primary-lighten/25 focus:bg-primary-darken/25 disabled:bg-primary-lighten/25",
            },
            {
                color: "primary-alt",
                variant: "outline",
                class: "text-primary-alt-base hover:bg-primary-alt-lighten/25 focus:bg-primary-alt-darken/25 disabled:bg-primary-alt-lighten/25",
            },
            {
                color: "secondary",
                variant: "outline",
                class: "text-secondary-base hover:bg-secondary-lighten/25 focus:bg-secondary-darken/25 disabled:bg-secondary-lighten/25",
            },
            {
                color: "secondary-alt",
                variant: "outline",
                class: "text-secondary-alt-base hover:bg-secondary-alt-lighten/25 focus:bg-secondary-alt-darken/25 disabled:bg-secondary-alt-lighten/25",
            },
            {
                color: "success",
                variant: "outline",
                class: "text-success-base hover:bg-success-lighten/25 focus:bg-success-darken/25 disabled:bg-success-lighten/25",
            },
            {
                color: "info",
                variant: "outline",
                class: "text-info-base hover:bg-info-lighten/25 focus:bg-info-darken/25 disabled:bg-info-lighten/25",
            },
            {
                color: "warning",
                variant: "outline",
                class: "text-warning-base hover:bg-warning-lighten/25 focus:bg-warning-darken/25 disabled:bg-warning-lighten/25",
            },
            {
                color: "danger",
                variant: "outline",
                class: "text-danger-base hover:bg-danger-lighten/25 focus:bg-danger-darken/25 disabled:bg-danger-lighten/25",
            },
        ],
        defaultVariants: {
            size: "default",
    ...
    const getIconColor = (color, variant) => {
        ...
        return ((_a = colors[color]) === null || _a === void 0 ? void 0 : _a.base) || colors.primary.base;
    };
    return {
        getIconColor,
        buttonComposed,
...
const Button = React.forwardRef((_a, ref) => {
    var { children, size = "default", color = "primary", variant = "filled", disabled = false, loading = false, className, onClick } = _a, rest = __rest(_a, ["children", "size", "color", "variant", "disabled", "loading", "className", "onClick"]);
    const { buttonComposed, getIconColor } = useButtonController();
    return (React.createElement("button", Object.assign({ ref: ref, className: clsx(buttonComposed({ size, color, variant, disabled }), className), disabled: disabled, onClick: onClick }, rest),
        children,
        loading && (React.createElement("span", { "aria-live": "polite", "aria-busy": "true", className: "ml-1" },
            React.createElement(Icon, { icon: "Loader", color: getIconColor(color, variant), size: 16, className: "animate-spin" })))));
});
...
export { Button, colors as Colors, Icon, icons };
