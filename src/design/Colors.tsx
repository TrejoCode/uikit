  ...
  <div className="w-full justify-center">
    <div className="container flex flex-col">
      ...
      <div className="flex flex-row px-4 mb-8">
        ...
        <div className="w-1/2 flex">
          <div className="w-full h-12 bg-info-base rounded-lg flex justify-center items-center text-white">#207b8D</div>
      ...
      <div className="flex flex-row px-4 mb-8">
        ...
        <div className="w-1/2">
          <div className="w-full h-12 bg-dark-gray rounded-lg flex justify-center items-center text-white">#4b4b4b</div>
        </div>
      </div>
    </div>
  </div>
